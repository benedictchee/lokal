...
/**
 * Core ingest logic extracted so tests can call it directly without needing
 * a real WorkflowEntrypoint constructor (which requires a native ExecutionContext).
 */
